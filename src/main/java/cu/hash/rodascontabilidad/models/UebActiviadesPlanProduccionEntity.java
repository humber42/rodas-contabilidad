...
@Entity
@Table(name = "ueb_activiades_plan_produccion", schema = "public", catalog = "rodas-contabilidad")
public class UebActiviadesPlanProduccionEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        UebActiviadesPlanProduccionEntity that = (UebActiviadesPlanProduccionEntity) o;
        return id == that.id &&
