...
@Entity
@Table(name = "categoria_agrupacion_indirecta", schema = "public", catalog = "rodas-contabilidad")
public class CategoriaAgrupacionIndirectaEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        CategoriaAgrupacionIndirectaEntity that = (CategoriaAgrupacionIndirectaEntity) o;
        return id == that.id &&
                orden == that.orden &&
