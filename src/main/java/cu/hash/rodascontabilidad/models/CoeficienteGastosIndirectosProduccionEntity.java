...
@Entity
@Table(name = "coeficiente_gastos_indirectos_produccion", schema = "public", catalog = "rodas-contabilidad")
public class CoeficienteGastosIndirectosProduccionEntity {
    private long id;
    ...
    public boolean equals(Object o) {
        ...
        CoeficienteGastosIndirectosProduccionEntity that = (CoeficienteGastosIndirectosProduccionEntity) o;
        return id == that.id &&
